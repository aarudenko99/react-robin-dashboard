...
const todoList = [
  {
    ...
    'yStudents': [
      ...
      {
        'avatarUrl': '/images/avatars/Calvin Robertson.svg',
        'name': 'Calvin Robertson',
        'date': 'May 19, 2020'
      },
      {
        'avatarUrl': '/images/avatars/Shawn Jones.svg',
        'name': 'Shawn Jones',
        'date': 'May 19, 2020'
      },
      {
        'avatarUrl': '/images/avatars/Lee Pena.svg',
        'name': 'Lee Pena',
        'date': 'May 19, 2020'
      },
      {
    ...
    'nStudents': [
      {
        'avatarUrl': '/images/avatars/Darrell Steward.svg',
    ...
    >
      <CardContent>
        <Grid container className={classes.container}>
          <Grid item xs={9}>
            <Typography className={classes.todoName}>To Do List name</Typography>
          </Grid>
          ...
          <Grid item sm={5} xs={4}>
            <Typography className={`${classes.duration} ${classes.badge}`}>{data.duration}</Typography>
          </Grid>

          <Grid item sm={2} xs={2}>
            <Typography className={`${classes.tasks} ${classes.badge}`}>{data.tasks}</Typography>
          </Grid>
        </Grid>
      </CardContent>
    </Card>
